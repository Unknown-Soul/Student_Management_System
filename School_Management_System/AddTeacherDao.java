...
public class AddTeacherDao
{
	...
	{    
		...
		try{
			...
			PreparedStatement ps=con.prepareStatement("insert into TeacherInfo(Name,Father_Name,Gender,date,Qualification,Email,Address,Pincode,Mobile,Mobile_1,Image,Document,Document_1,Course) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			ps.setString(1,name);
